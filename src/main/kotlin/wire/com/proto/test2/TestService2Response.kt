...
public class TestService2Response(
  /**
  ...
  @field:WireField(
    tag = 36,
    adapter = "com.proto.test2.TestService2Response${'$'}Corpus#ADAPTER"
  )
  ...
  @field:WireField(
    tag = 39,
    adapter = "com.proto.test2.TestService2Response${'$'}NestedMessage#ADAPTER",
    oneofName = "oneOfField"
  )
  ...
  public val extension: Int? = null,
  unknownFields: ByteString = ByteString.EMPTY
) : AndroidMessage<TestService2Response, Nothing>(ADAPTER, unknownFields) {
  /**
  ...
  @field:WireField(
    tag = 41,
    adapter = "com.proto.test2.TestService2Response${'$'}MapFieldEntry#ADAPTER",
  ...
  public override fun equals(other: Any?): Boolean {
    ...
    if (other !is TestService2Response) return false
  ...
  public override fun toString(): String {
    ...
    return result.joinToString(prefix = "TestService2Response{", separator = ", ", postfix = "}")
  }
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields
  ): TestService2Response = TestService2Response(optionalDouble, requiredDouble, optionalInt32,
      ...
      optionalWithDefaultString, corpus, samples, name, nested, map, map_field, extension,
      unknownFields)
  ...
  public companion object {
    ...
    @JvmField
    public val ADAPTER: ProtoAdapter<TestService2Response> = object :
        ProtoAdapter<TestService2Response>(
      FieldEncoding.LENGTH_DELIMITED, 
      TestService2Response::class, 
      "type.googleapis.com/test2.TestService2Response", 
      PROTO_2, 
      null, 
      "test2.proto"
    ) {
      ...
      public override fun encodedSize(`value`: TestService2Response): Int {
        ...
        size += ProtoAdapter.INT32.encodedSizeWithTag(126, value.extension)
        return size
      }

      public override fun encode(writer: ProtoWriter, `value`: TestService2Response): Unit {
      ...
      public override fun encode(writer: ReverseProtoWriter, `value`: TestService2Response): Unit {
        writer.writeBytes(value.unknownFields)
        NestedMessage.ADAPTER.encodeWithTag(writer, 39, value.nested)
        ProtoAdapter.STRING.encodeWithTag(writer, 38, value.name)
        ProtoAdapter.INT32.encodeWithTag(writer, 126, value.extension)
      ...
      public override fun decode(reader: ProtoReader): TestService2Response {
        ...
        val unknownFields = reader.forEachTag { tag ->
          when (tag) {
            ...
            126 -> extension = ProtoAdapter.INT32.decode(reader)
            else -> reader.readUnknownField(tag)
          }
        }
        return TestService2Response(
      ...
      public override fun redact(`value`: TestService2Response): TestService2Response = value.copy(
    ...
    @JvmField
    public val CREATOR: Parcelable.Creator<TestService2Response> =
  ...
  public class NestedMessage(
    ...
    public companion object {
      ...
      public val ADAPTER: ProtoAdapter<NestedMessage> = object : ProtoAdapter<NestedMessage>(
        FieldEncoding.LENGTH_DELIMITED, 
        NestedMessage::class, 
        "type.googleapis.com/test2.TestService2Response.NestedMessage", 
        PROTO_2, 
        null, 
        "test2.proto"
      ) {
  ...
  public class MapFieldEntry(
    ...
    public companion object {
      ...
      public val ADAPTER: ProtoAdapter<MapFieldEntry> = object : ProtoAdapter<MapFieldEntry>(
        FieldEncoding.LENGTH_DELIMITED, 
        MapFieldEntry::class, 
        "type.googleapis.com/test2.TestService2Response.MapFieldEntry", 
        PROTO_2, 
        null, 
        "test2.proto"
      ) {
