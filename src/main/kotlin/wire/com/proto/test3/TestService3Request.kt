...
public class TestService3Request(
  /**
  ...
  public val requiredDouble: Double = 0.0,
  @field:WireField(
    tag = 4,
  ...
  public val requiredInt32: Int = 0,
  @field:WireField(
    tag = 6,
  ...
  public val requiredInt64: Long = 0L,
  @field:WireField(
    tag = 8,
  ...
  public val requiredUint32: Int = 0,
  @field:WireField(
    tag = 13,
  ...
  public val requiredUint64: Long = 0L,
  @field:WireField(
    tag = 16,
  ...
  public val requiredSint32: Int = 0,
  @field:WireField(
    tag = 18,
  ...
  public val requiredSint64: Long = 0L,
  @field:WireField(
    tag = 20,
  ...
  public val requiredFixed32: Int = 0,
  @field:WireField(
    tag = 22,
  ...
  public val requiredFixed64: Long = 0L,
  @field:WireField(
    tag = 24,
  ...
  public val requiredSfixed32: Int = 0,
  @field:WireField(
    tag = 26,
  ...
  public val requiredSfixed64: Long = 0L,
  @field:WireField(
    tag = 28,
  ...
  public val requiredBool: Boolean = false,
  @field:WireField(
    tag = 30,
  ...
  public val requiredBytes: ByteString = ByteString.EMPTY,
  @field:WireField(
    tag = 36,
  ...
  public override fun equals(other: Any?): Boolean {
    ...
    if (other !is TestService3Request) return false
  ...
  public override fun toString(): String {
    ...
    return result.joinToString(prefix = "TestService3Request{", separator = ", ", postfix = "}")
  }
  ...
  ): TestService3Request = TestService3Request(optionalDouble, requiredDouble, optionalInt32,
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<TestService3Request> = object :
        ProtoAdapter<TestService3Request>(
      FieldEncoding.LENGTH_DELIMITED, 
      TestService3Request::class, 
      "type.googleapis.com/test3.TestService3Request", 
      PROTO_3, 
      null, 
      "test3.proto"
    ) {
      ...
      public override fun encodedSize(`value`: TestService3Request): Int {
        var size = value.unknownFields.size
        size += ProtoAdapter.DOUBLE.encodedSizeWithTag(1, value.optionalDouble)
        if (!value.requiredDouble.equals(0.0)) size += ProtoAdapter.DOUBLE.encodedSizeWithTag(3,
            value.requiredDouble)
        size += ProtoAdapter.INT32.encodedSizeWithTag(4, value.optionalInt32)
        if (value.requiredInt32 != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(5,
            value.requiredInt32)
        size += ProtoAdapter.INT64.encodedSizeWithTag(6, value.optionalInt64)
        if (value.requiredInt64 != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(7,
            value.requiredInt64)
        size += ProtoAdapter.UINT32.encodedSizeWithTag(8, value.optionalUint32)
        if (value.requiredUint32 != 0) size += ProtoAdapter.UINT32.encodedSizeWithTag(12,
            value.requiredUint32)
        size += ProtoAdapter.UINT64.encodedSizeWithTag(13, value.optionalUint64)
        if (value.requiredUint64 != 0L) size += ProtoAdapter.UINT64.encodedSizeWithTag(14,
            value.requiredUint64)
        size += ProtoAdapter.SINT32.encodedSizeWithTag(16, value.optionalSint32)
        if (value.requiredSint32 != 0) size += ProtoAdapter.SINT32.encodedSizeWithTag(17,
            value.requiredSint32)
        size += ProtoAdapter.SINT64.encodedSizeWithTag(18, value.optionalSint64)
        if (value.requiredSint64 != 0L) size += ProtoAdapter.SINT64.encodedSizeWithTag(19,
            value.requiredSint64)
        size += ProtoAdapter.FIXED32.encodedSizeWithTag(20, value.optionalFixed32)
        if (value.requiredFixed32 != 0) size += ProtoAdapter.FIXED32.encodedSizeWithTag(21,
            value.requiredFixed32)
        size += ProtoAdapter.FIXED64.encodedSizeWithTag(22, value.optionalFixed64)
        if (value.requiredFixed64 != 0L) size += ProtoAdapter.FIXED64.encodedSizeWithTag(23,
            value.requiredFixed64)
        size += ProtoAdapter.SFIXED32.encodedSizeWithTag(24, value.optionalSfixed32)
        if (value.requiredSfixed32 != 0) size += ProtoAdapter.SFIXED32.encodedSizeWithTag(25,
            value.requiredSfixed32)
        size += ProtoAdapter.SFIXED64.encodedSizeWithTag(26, value.optionalSfixed64)
        if (value.requiredSfixed64 != 0L) size += ProtoAdapter.SFIXED64.encodedSizeWithTag(27,
            value.requiredSfixed64)
        size += ProtoAdapter.BOOL.encodedSizeWithTag(28, value.optionalBool)
        if (value.requiredBool != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(29,
            value.requiredBool)
        size += ProtoAdapter.STRING.encodedSizeWithTag(30, value.optionalString)
        if (value.requiredString != "") size += ProtoAdapter.STRING.encodedSizeWithTag(31,
            value.requiredString)
        size += ProtoAdapter.BYTES.encodedSizeWithTag(32, value.optionalBytes)
        if (value.requiredBytes != ByteString.EMPTY) size +=
            ProtoAdapter.BYTES.encodedSizeWithTag(33, value.requiredBytes)
      ...
      public override fun encode(writer: ProtoWriter, `value`: TestService3Request): Unit {
        ProtoAdapter.DOUBLE.encodeWithTag(writer, 1, value.optionalDouble)
        if (!value.requiredDouble.equals(0.0)) ProtoAdapter.DOUBLE.encodeWithTag(writer, 3,
            value.requiredDouble)
        ProtoAdapter.INT32.encodeWithTag(writer, 4, value.optionalInt32)
        if (value.requiredInt32 != 0) ProtoAdapter.INT32.encodeWithTag(writer, 5,
            value.requiredInt32)
        ProtoAdapter.INT64.encodeWithTag(writer, 6, value.optionalInt64)
        if (value.requiredInt64 != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 7,
            value.requiredInt64)
        ProtoAdapter.UINT32.encodeWithTag(writer, 8, value.optionalUint32)
        if (value.requiredUint32 != 0) ProtoAdapter.UINT32.encodeWithTag(writer, 12,
            value.requiredUint32)
        ProtoAdapter.UINT64.encodeWithTag(writer, 13, value.optionalUint64)
        if (value.requiredUint64 != 0L) ProtoAdapter.UINT64.encodeWithTag(writer, 14,
            value.requiredUint64)
        ProtoAdapter.SINT32.encodeWithTag(writer, 16, value.optionalSint32)
        if (value.requiredSint32 != 0) ProtoAdapter.SINT32.encodeWithTag(writer, 17,
            value.requiredSint32)
        ProtoAdapter.SINT64.encodeWithTag(writer, 18, value.optionalSint64)
        if (value.requiredSint64 != 0L) ProtoAdapter.SINT64.encodeWithTag(writer, 19,
            value.requiredSint64)
        ProtoAdapter.FIXED32.encodeWithTag(writer, 20, value.optionalFixed32)
        if (value.requiredFixed32 != 0) ProtoAdapter.FIXED32.encodeWithTag(writer, 21,
            value.requiredFixed32)
        ProtoAdapter.FIXED64.encodeWithTag(writer, 22, value.optionalFixed64)
        if (value.requiredFixed64 != 0L) ProtoAdapter.FIXED64.encodeWithTag(writer, 23,
            value.requiredFixed64)
        ProtoAdapter.SFIXED32.encodeWithTag(writer, 24, value.optionalSfixed32)
        if (value.requiredSfixed32 != 0) ProtoAdapter.SFIXED32.encodeWithTag(writer, 25,
            value.requiredSfixed32)
        ProtoAdapter.SFIXED64.encodeWithTag(writer, 26, value.optionalSfixed64)
        if (value.requiredSfixed64 != 0L) ProtoAdapter.SFIXED64.encodeWithTag(writer, 27,
            value.requiredSfixed64)
        ProtoAdapter.BOOL.encodeWithTag(writer, 28, value.optionalBool)
        if (value.requiredBool != false) ProtoAdapter.BOOL.encodeWithTag(writer, 29,
            value.requiredBool)
        ProtoAdapter.STRING.encodeWithTag(writer, 30, value.optionalString)
        if (value.requiredString != "") ProtoAdapter.STRING.encodeWithTag(writer, 31,
            value.requiredString)
        ProtoAdapter.BYTES.encodeWithTag(writer, 32, value.optionalBytes)
        if (value.requiredBytes != ByteString.EMPTY) ProtoAdapter.BYTES.encodeWithTag(writer, 33,
            value.requiredBytes)
      ...
      public override fun encode(writer: ReverseProtoWriter, `value`: TestService3Request): Unit {
        writer.writeBytes(value.unknownFields)
        NestedMessage.ADAPTER.encodeWithTag(writer, 39, value.nested)
        ProtoAdapter.STRING.encodeWithTag(writer, 38, value.name)
        AnyMessage.ADAPTER.asRepeated().encodeWithTag(writer, 42, value.details)
      ...
      public override fun decode(reader: ProtoReader): TestService3Request {
        var optionalDouble: Double? = null
        var requiredDouble: Double = 0.0
        var optionalInt32: Int? = null
        var requiredInt32: Int = 0
        var optionalInt64: Long? = null
        var requiredInt64: Long = 0L
        var optionalUint32: Int? = null
        var requiredUint32: Int = 0
        var optionalUint64: Long? = null
        var requiredUint64: Long = 0L
        var optionalSint32: Int? = null
        var requiredSint32: Int = 0
        var optionalSint64: Long? = null
        var requiredSint64: Long = 0L
        var optionalFixed32: Int? = null
        var requiredFixed32: Int = 0
        var optionalFixed64: Long? = null
        var requiredFixed64: Long = 0L
        var optionalSfixed32: Int? = null
        var requiredSfixed32: Int = 0
        var optionalSfixed64: Long? = null
        var requiredSfixed64: Long = 0L
        var optionalBool: Boolean? = null
        var requiredBool: Boolean = false
        var optionalString: String? = null
        var requiredString: String = ""
        var optionalBytes: ByteString? = null
        var requiredBytes: ByteString = ByteString.EMPTY
      ...
      public override fun redact(`value`: TestService3Request): TestService3Request = value.copy(
  ...
  /**
   * Defaults not supported in proto3
  ...
  public class NestedMessage(
    ...
    public companion object {
      ...
      public val ADAPTER: ProtoAdapter<NestedMessage> = object : ProtoAdapter<NestedMessage>(
        FieldEncoding.LENGTH_DELIMITED, 
        NestedMessage::class, 
        "type.googleapis.com/test3.TestService3Request.NestedMessage", 
        PROTO_3, 
        null, 
        "test3.proto"
      ) {
  ...
  public class MapFieldEntry(
    ...
    public companion object {
      ...
      public val ADAPTER: ProtoAdapter<MapFieldEntry> = object : ProtoAdapter<MapFieldEntry>(
        FieldEncoding.LENGTH_DELIMITED, 
        MapFieldEntry::class, 
        "type.googleapis.com/test3.TestService3Request.MapFieldEntry", 
        PROTO_3, 
        null, 
        "test3.proto"
      ) {
        public override fun encodedSize(`value`: MapFieldEntry): Int {
          ...
          if (value.value_ != null) size += NestedMessage.ADAPTER.encodedSizeWithTag(2,
              value.value_)
          return size
        }
        ...
        public override fun encode(writer: ProtoWriter, `value`: MapFieldEntry): Unit {
          ...
          if (value.value_ != null) NestedMessage.ADAPTER.encodeWithTag(writer, 2, value.value_)
          writer.writeBytes(value.unknownFields)
        }
