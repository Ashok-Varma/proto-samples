...
public class TestService3Response(
  /**
  ...
  @field:WireField(
    tag = 41,
    adapter = "com.proto.test3.TestService3Response${'$'}MapFieldEntry#ADAPTER",
  ...
  public override fun equals(other: Any?): Boolean {
    ...
    if (other !is TestService3Response) return false
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<TestService3Response> = object :
        ProtoAdapter<TestService3Response>(
      FieldEncoding.LENGTH_DELIMITED, 
      TestService3Response::class, 
      "type.googleapis.com/test3.TestService3Response", 
      PROTO_3, 
      null, 
      "test3.proto"
    ) {
      ...
      public override fun encodedSize(`value`: TestService3Response): Int {
      ...
      public override fun encode(writer: ProtoWriter, `value`: TestService3Response): Unit {
      ...
      public override fun encode(writer: ReverseProtoWriter, `value`: TestService3Response): Unit {
        writer.writeBytes(value.unknownFields)
        NestedMessage.ADAPTER.encodeWithTag(writer, 39, value.nested)
        ProtoAdapter.STRING.encodeWithTag(writer, 38, value.name)
        if (value.requiredMessageObject != null) NestedMessage.ADAPTER.encodeWithTag(writer, 43,
      ...
      public override fun decode(reader: ProtoReader): TestService3Response {
      ...
      public override fun redact(`value`: TestService3Response): TestService3Response = value.copy(
    ...
    @JvmField
    public val CREATOR: Parcelable.Creator<TestService3Response> =
  ...
  public class NestedMessage(
    ...
    public companion object {
      ...
      public val ADAPTER: ProtoAdapter<NestedMessage> = object : ProtoAdapter<NestedMessage>(
        FieldEncoding.LENGTH_DELIMITED, 
        NestedMessage::class, 
        "type.googleapis.com/test3.TestService3Response.NestedMessage", 
        PROTO_3, 
        null, 
        "test3.proto"
      ) {
  ...
  public class MapFieldEntry(
    ...
    public companion object {
      ...
      public val ADAPTER: ProtoAdapter<MapFieldEntry> = object : ProtoAdapter<MapFieldEntry>(
        FieldEncoding.LENGTH_DELIMITED, 
        MapFieldEntry::class, 
        "type.googleapis.com/test3.TestService3Response.MapFieldEntry", 
        PROTO_3, 
        null, 
        "test3.proto"
      ) {
