...
public final class TestService2Response extends AndroidMessage<TestService2Response, TestService2Response.Builder> {
  ...
  public static final Parcelable.Creator<TestService2Response> CREATOR = AndroidMessage.newCreator(ADAPTER);
  ...
  public static final Integer DEFAULT_EXTENSION = 0;
  ...
  @Nullable
  public final Integer extension;
  ...
  public TestService2Response(Builder builder, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof TestService2Response)) return false;
    TestService2Response o = (TestService2Response) other;
  ...
  public static final class Builder extends Message.Builder<TestService2Response, Builder> {
    ...
    @Override
    public TestService2Response build() {
      ...
      return new TestService2Response(this, super.buildUnknownFields());
    }
  }
