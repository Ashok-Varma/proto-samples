...
public final class TestService3Response extends Message<TestService3Response, TestService3Response.Builder> {
  public static final ProtoAdapter<TestService3Response> ADAPTER = new ProtoAdapter_TestService3Response();
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof TestService3Response)) return false;
    TestService3Response o = (TestService3Response) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "TestService3Response{").append('}').toString();
  }

  public static final class Builder extends Message.Builder<TestService3Response, Builder> {
    ...
    @Override
    public TestService3Response build() {
      return new TestService3Response(this, super.buildUnknownFields());
    }
  }
  ...
  public static final class NestedMessage extends Message<NestedMessage, NestedMessage.Builder> {
    ...
    private static final class ProtoAdapter_NestedMessage extends ProtoAdapter<NestedMessage> {
      public ProtoAdapter_NestedMessage() {
        super(FieldEncoding.LENGTH_DELIMITED, NestedMessage.class, "type.googleapis.com/test3.TestService3Response.NestedMessage", Syntax.PROTO_3, null, "test3.proto");
      }
  ...
  public static final class MapFieldEntry extends Message<MapFieldEntry, MapFieldEntry.Builder> {
    ...
    private static final class ProtoAdapter_MapFieldEntry extends ProtoAdapter<MapFieldEntry> {
      public ProtoAdapter_MapFieldEntry() {
        super(FieldEncoding.LENGTH_DELIMITED, MapFieldEntry.class, "type.googleapis.com/test3.TestService3Response.MapFieldEntry", Syntax.PROTO_3, null, "test3.proto");
      }
  ...
  private static final class ProtoAdapter_TestService3Response extends ProtoAdapter<TestService3Response> {
    private ProtoAdapter<Map<String, NestedMessage>> map;

    public ProtoAdapter_TestService3Response() {
      super(FieldEncoding.LENGTH_DELIMITED, TestService3Response.class, "type.googleapis.com/test3.TestService3Response", Syntax.PROTO_3, null, "test3.proto");
    }

    @Override
    public int encodedSize(TestService3Response value) {
      int result = 0;
    ...
    @Override
    public void encode(ProtoWriter writer, TestService3Response value) throws IOException {
    ...
    @Override
    public void encode(ReverseProtoWriter writer, TestService3Response value) throws IOException {
      writer.writeBytes(value.unknownFields());
      NestedMessage.ADAPTER.encodeWithTag(writer, 39, value.nested);
      ProtoAdapter.STRING.encodeWithTag(writer, 38, value.name);
      AnyMessage.ADAPTER.asRepeated().encodeWithTag(writer, 42, value.details);
    ...
    @Override
    public TestService3Response decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
      long token = reader.beginMessage();
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
    ...
    @Override
    public TestService3Response redact(TestService3Response value) {
      Builder builder = value.newBuilder();
